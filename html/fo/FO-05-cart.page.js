  ...
  function CartPage() {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { "data-screen-label": "FO-05 \uC7A5\uBC14\uAD6C\uB2C8", className: "fo-two", style: { paddingTop: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 0" } }, /* @__PURE__ */ React.createElement(Checkbox, { checked: allOn, indeterminate: sel.length > 0 && !allOn, label: "\uC804\uCCB4 \uC120\uD0DD (" + sel.length + "/" + cart.length + ")", onChange: (on) => setSel(on ? cart.map((c) => c.id) : []) }), /* @__PURE__ */ React.createElement(Button, { variant: "ghost", size: "sm", disabled: !sel.length, onClick: () => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: it.id, style: { display: "flex", gap: 10, padding: "16px 0", borderTop: i ? "1px solid var(--border-default)" : "none", alignItems: "flex-start", opacity: it.missing ? 0.7 : 1 } }, /* @__PURE__ */ React.createElement("div", { style: { paddingTop: 22 } }, /* @__PURE__ */ React.createElement(Checkbox, { checked: sel.includes(it.id), onChange: (on) => setSel(on ? [...sel, it.id] : sel.filter((x) => x !== it.id)) })), /* @__PURE__ */ React.createElement("a", { href: it.missing ? void 0 : F.sheetUrl(it), style: { width: 56, flex: "none", borderRadius: 8, overflow: "hidden", border: "1px solid var(--border-default)", pointerEvents: it.missing ? "none" : void 0 } }, /* @__PURE__ */ React.createElement(F.StaffThumb, { ratio: "1 / 1", size: 18, src: cover || void 0, alt: it.title, watermark: cover ? "light" : false })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", gap: 8 } }, it.missing ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 600, letterSpacing: "-0.3px", color: "var(--text-secondary)" } }, it.title) : /* @__PURE__ */ React.createElement("a", { href: F.sheetUrl(it), style: { fontSize: 14, fontWeight: 600, letterSpacing: "-0.3px" } }, it.title), /* @__PURE__ */ React.createElement(IconButton, { name: "x", variant: "ghost", size: "sm", label: "\uC0AD\uC81C", onClick: () => {
