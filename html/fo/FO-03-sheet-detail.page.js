(() => {
  ...
  function YouTubeFallback({ id, title }) {
    ...
    return /* @__PURE__ */ React.createElement("a", { className: "fo-yt fo-yt-fallback", href: watch, target: "_blank", rel: "noopener noreferrer", "aria-label": label }, thumb ? /* @__PURE__ */ React.createElement("img", { className: "fo-yt-fallback-img", src: thumb, alt: "", decoding: "async" }) : null, /* @__PURE__ */ React.createElement("div", { className: "fo-yt-fallback-scrim", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", { className: "fo-yt-open" }, "YouTube\uC5D0\uC11C \uBCF4\uAE30"));
  }
  ...
  function DetailPage() {
    ...
    React.useEffect(() => {
      ...
      A.sheets.getBySlug(slugPath).then((row) => {
    ...
    if (!bootReady || slugPath && !s && (slugPending || !slugResolved)) {
      return /* @__PURE__ */ React.createElement(F.Scaffold, { title: "\uC545\uBCF4 \uC0C1\uC138", back: F.PAGES.list }, /* @__PURE__ */ React.createElement("p", { className: "fo-caption", style: { textAlign: "center", padding: "48px 16px" } }, "\uC545\uBCF4 \uC815\uBCF4\uB97C \uBD88\uB7EC\uC624\uB294 \uC911\u2026"));
    }
    if (!s) {
    ...
    return /* @__PURE__ */ React.createElement(F.Scaffold, { title: "\uC545\uBCF4 \uC0C1\uC138", back: F.PAGES.list, cta: /* @__PURE__ */ React.createElement(CtaButtons, null) }, /* @__PURE__ */ React.createElement("div", { "data-screen-label": "FO-03 \uC545\uBCF4 \uC0C1\uC138", className: "fo-two", style: { paddingTop: 20 } }, /* @__PURE__ */ React.createElement("div", { className: "fo-side-sticky", style: { display: "flex", flexDirection: "column", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, s.popular ? /* @__PURE__ */ React.createElement(Badge, { variant: "solid", size: "sm" }, "\uC778\uAE30") : null, s.isNew ? /* @__PURE__ */ React.createElement(Badge, { variant: "solid", size: "sm" }, "NEW") : null, /* @__PURE__ */ React.createElement(Badge, { variant: "outline", size: "sm" }, s.level), /* @__PURE__ */ React.createElement(Badge, { variant: "neutral", size: "sm" }, s.genre)), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: "clamp(22px, 3vw, 28px)", letterSpacing: "-0.9px", lineHeight: 1.25 } }, s.title), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "var(--text-secondary)" } }, /* @__PURE__ */ React.createElement("span", null, s.artist)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 8 } }, /* @__PURE__ */ React.createElement(F.Money, { value: s.price, size: 28 }), s.orig ? /* @__PURE__ */ React.createElement(F.Money, { value: s.orig, size: 15, strike: true }) : null, s.orig ? /* @__PURE__ */ React.createElement(Badge, { variant: "danger", size: "sm" }, Math.round((1 - s.price / s.orig) * 100), "% \uD560\uC778") : null), /* @__PURE__ */ React.createElement("div", { style: { padding: "14px 16px", border: "1px solid var(--border-default)", borderRadius: "var(--radius-cards)", display: "flex", flexDirection: "column", gap: 10, background: "var(--surface-card)" } }, [["\uC7A5\uB974", s.genre], ["\uB09C\uC774\uB3C4", s.level], ["\uD398\uC774\uC9C0", s.pages + "\uD398\uC774\uC9C0"], ["\uD30C\uC77C \uD615\uC2DD", "PDF"], ["\uB2E4\uC6B4\uB85C\uB4DC", "\uACB0\uC81C\uC77C\uB85C\uBD80\uD130 7\uC77C\uAC04"]].map(([k, v]) => /* @__PURE__ */ React.createElement(F.KV, { key: k, k, v: /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500 } }, v) }))), /* @__PURE__ */ React.createElement("div", { className: "fo-desktop", style: { display: "flex", gap: 10, marginTop: 6 } }, /* @__PURE__ */ React.createElement(CtaButtons, null)), /* @__PURE__ */ React.createElement("p", { className: "fo-caption", style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(Icon, { name: "info", size: 13, style: { color: "var(--color-icon)" } }), "\uACB0\uC81C\uB294 \uC7A5\uBC14\uAD6C\uB2C8\uC5D0\uC11C \uC9C4\uD589\uB3FC\uC694. \uBC14\uB85C \uACB0\uC81C\uB294 \uC9C0\uC6D0\uD558\uC9C0 \uC54A\uC544\uC694.")), /* @__PURE__ */ React.createElement("div", { className: "fo-detail-main" }, ytId ? /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement(Card, { padding: 0, style: { overflow: "visible" } }, /* @__PURE__ */ React.createElement(YouTubePlayer, { url: ytUrl, title: s.title })), /* @__PURE__ */ React.createElement("p", { className: "fo-caption", style: { marginTop: 10, display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(Icon, { name: "play", size: 13, style: { color: "var(--color-icon)" } }), "\uD398\uC774\uC9C0\uC5D0\uC11C \uBC14\uB85C \uC7AC\uC0DD\uD558\uAC70\uB098, \uC548 \uB418\uBA74 YouTube\uC5D0\uC11C \uC5F4 \uC218 \uC788\uC5B4\uC694.")) : null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } }, (previewUrls.length ? previewUrls : [null]).map((url, i) => /* @__PURE__ */ React.createElement(Card, { key: i, padding: 0, style: { overflow: "hidden" } }, /* @__PURE__ */ React.createElement(F.StaffThumb, { ratio: "5 / 4", size: 44, watermark: "strong", fit: "cover", src: url || void 0, alt: url ? "\uBBF8\uB9AC\uBCF4\uAE30 " + (i + 1) + "\uD398\uC774\uC9C0" : "" })))), /* @__PURE__ */ React.createElement("p", { className: "fo-caption", style: { marginTop: 10, display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement(Icon, { name: "eye", size: 13, style: { color: "var(--color-icon)" } }), "\uBBF8\uB9AC\uBCF4\uAE30\uB294 1\u20132\uD398\uC774\uC9C0\uB9CC \uC81C\uACF5\uB418\uBA70, \uC77C\uBD80\uB9CC \uBCF4\uC774\uB3C4\uB85D \uCC98\uB9AC\uB3FC\uC694."))), /* @__PURE__ */ React.createElement("section", { style: { marginTop: 44 } }, /* @__PURE__ */ React.createElement(F.SectionHeader, { title: "\uAD00\uB828 \uC545\uBCF4", action: "\uB354\uBCF4\uAE30", href: F.PAGES.list + "?cat=" + encodeURIComponent(s.genre) }), /* @__PURE__ */ React.createElement("div", { className: "fo-grid" }, related.map((r) => /* @__PURE__ */ React.createElement(F.SheetCard, { key: r.id, s: r })))), /* @__PURE__ */ React.createElement(F.CartAddedDialog, { open: cartAsk, onClose: () => setCartAsk(false), message: cartMsg }));
  }
