(() => {
  ...
  function StaffThumb({ ratio = "1 / 1", icon = "music", size = 30, watermark = false, fill = false, src, alt = "", fit = "cover", position = "top center" }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", height: fill ? "100%" : "auto", aspectRatio: fill ? "auto" : ratio, background: "var(--surface-thumb, #f6f6f6)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" } }, src ? /* @__PURE__ */ React.createElement("img", { src, alt, style: { position: "relative", zIndex: 1, width: "100%", height: "100%", objectFit: fit, objectPosition: position, background: "#fff" } }) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, backgroundImage: "repeating-linear-gradient(180deg, transparent 0 15px, var(--staff-line, #e7e7e7) 15px 16px)", backgroundPosition: "0 14px" } }), /* @__PURE__ */ React.createElement(Icon, { name: icon, size, style: { color: "var(--thumb-icon, #cccccc)", position: "relative" } })), showWm ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", style: {
      position: "absolute",
      inset: 0,
      zIndex: 3,
      pointerEvents: "none",
  ...
  function CartIcon() {
    ...
    return /* @__PURE__ */ React.createElement("a", { href: PAGES.cart, style: { position: "relative", display: "inline-flex" }, "aria-label": "\uC7A5\uBC14\uAD6C\uB2C8" }, /* @__PURE__ */ React.createElement(IconButton, { name: "shopping-cart", variant: "ghost", label: "\uC7A5\uBC14\uAD6C\uB2C8" }), n ? /* @__PURE__ */ React.createElement("span", { className: "ds-mono", style: { position: "absolute", top: 2, right: 2, minWidth: 16, height: 16, padding: "0 4px", borderRadius: 9999, background: "var(--color-ink)", color: "var(--color-paper-white)", fontSize: 10, fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none" } }, n) : null);
  }
  function FoLogo({ size = 32, alt = "CHODRUM \uB85C\uACE0" }) {
    return /* @__PURE__ */ React.createElement("span", { className: "fo-logo", style: { width: size, height: size }, "aria-hidden": alt ? void 0 : true }, /* @__PURE__ */ React.createElement("img", { className: "fo-logo-img fo-logo-light", src: "/shared/logo.png", alt: alt || "", width: size, height: size }), /* @__PURE__ */ React.createElement("img", { className: "fo-logo-img fo-logo-dark", src: "/shared/logo-white.png", alt: "", width: size, height: size }));
  }
  function ThemeToggle() {
    const [theme, setTheme] = React.useState(() => window.FoTheme && typeof window.FoTheme.get === "function" ? window.FoTheme.get() : "light");
    React.useEffect(() => {
      const on = (e) => {
